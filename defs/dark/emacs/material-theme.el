...
(custom-theme-set-faces
 ...
 '(company-tooltip-common-selection  ((t (:foreground "[material:accent1-normal]"    :background "[material:menu-active-bg]" :bold t))))
 '(company-tooltip-mouse             ((t (:foreground "[material:menu-active-fg]" :background "[material:menu-active-bg]" :bold t))))
 '(company-tooltip-selection         ((t (:foreground "[material:menu-active-fg]" :background "[material:menu-active-bg]" :bold t))))
