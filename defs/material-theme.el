...
(custom-theme-set-faces
 ...
 `(popup-tip-face      ((t (:foreground "[material:view-bg]" :background "[material:view-tx]"))))
 ...
 ;; Latex
 `(font-latex-sectioning-5-face  ((t (:foreground "[material:text-section-tx]" :weight bold ))))
 ...
 `(markdown-header-face  ((t (:foreground "[material:text-section-tx]" :weight bold))))
 ...
 ;; `(org-done ((t (:foreground ,material/green :background nil))))
 ;; `(org-todo ((t (:foreground ,material/red :background nil))))
