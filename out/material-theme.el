...
(custom-theme-set-faces
 ...
 '(ediff-current-diff-A   ((t (:foreground nil :background "#d01716"))))
 '(ediff-current-diff-B   ((t (:foreground nil :background "#0a7e07"))))
 '(ediff-current-diff-C   ((t (:foreground nil :background "#455ede"))))
